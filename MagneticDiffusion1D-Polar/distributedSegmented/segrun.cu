...
int main( void ) {
  ...
  HANDLE_ERROR( cudaMalloc( (void**)&temp, ((2*gpusteps)-1)*numseg * sizeof(double) ) );
  ...
  do{
    ...
    //update
    update<<<numseg,1>>>(dev_new, dev_old, numseg+1, dev_conv, thresh, aug, gpusteps, temp);
